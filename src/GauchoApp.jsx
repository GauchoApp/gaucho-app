  ...
  const renderVipLogin = () => (
    <div style={{ padding: "20px 20px 120px 20px", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      {showCreateAccountForm ? (
        <form onSubmit={(e) => { e.preventDefault(); handleCreateAccount(); }} style={{ width: "100%", maxWidth: "390px", backgroundColor: C.bgCard, padding: "24px", borderRadius: "8px", border: `1px solid ${C.border}` }}>
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }} style={{ width: "100%", maxWidth: "390px", backgroundColor: C.bgCard, padding: "24px", borderRadius: "8px", border: `1px solid ${C.border}` }}>
